---
name: roblox-fundamentals-and-services
description: >
...
- DataStoreService, MemoryStoreService, MessagingService (see data-persistence skill)
...
This fundamentals skill is the base. Load the specialized skills (data, UI, animation, particles, monetization, client-server) on top of it.
