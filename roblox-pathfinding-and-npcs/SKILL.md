...
Cross-reference:
- [roblox-fundamentals-and-services/SKILL.md](../roblox-fundamentals-and-services/SKILL.md) for services and Humanoid basics.
- [roblox-client-server-networking-and-security/SKILL.md](../roblox-client-server-networking-and-security/SKILL.md) for server-authoritative AI.
- [roblox-physics-and-constraints/SKILL.md](../roblox-physics-and-constraints/SKILL.md) for custom non-humanoid rigs and mover constraints.
- [roblox-testing-and-debugging/SKILL.md](../roblox-testing-and-debugging/SKILL.md) for profiling AI cost.
