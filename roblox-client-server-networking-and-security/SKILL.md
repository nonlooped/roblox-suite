---
name: roblox-client-server-networking-and-security
...
This skill + fundamentals + the domain skills (data, UI, animation, etc.) produces code that is both correct in behavior and resistant to the hostile client environment that is Roblox multiplayer.
