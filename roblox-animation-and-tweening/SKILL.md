---
name: roblox-animation-and-tweening
...
- Combine with roblox-visual-effects-and-particles when animations should trigger emitters, beams, or trails via markers.
- Combine with roblox-fundamentals-and-services for Animator acquisition, RunService timing, and preloading via ContentProvider.
- Use roblox-client-server-networking-and-security to decide where to play/ control animations (server replication vs client-only cosmetics).
...
This skill + the UI and particles skills will let you create motion that feels intentional, responsive, and polished rather than "it moves."
