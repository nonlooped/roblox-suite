...
Cross-reference:
- [roblox-suite/SKILL.md](../roblox-suite/SKILL.md) for general Roblox architecture and specialized development skills.
- [roblox-fundamentals-and-services/SKILL.md](../roblox-fundamentals-and-services/SKILL.md) for services, script locations, and the data model.
