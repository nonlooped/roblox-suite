---
name: roblox-visual-effects-and-particles
...
Use these together with the animation skill's marker system and the UI skill's ViewportFrame embedding to create cohesive, high-production visual language.
