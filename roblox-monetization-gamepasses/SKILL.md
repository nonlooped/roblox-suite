---
name: roblox-monetization-gamepasses
description: >
...
# roblox-monetization-gamepasses
...
See roblox-data-persistence for how to store "player owns this pass" state or associated perks, and roblox-client-server-networking-and-security for the Remote validation layer around purchase prompts.
...
- For RTBF / right-to-be-forgotten, include pass-related keys in your deletion patterns (see data-persistence skill).
...
This skill + data-persistence + client-server gives you a complete, secure, modern game pass implementation that follows current rules and best practices.
