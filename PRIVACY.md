...
Roblox Suite does not collect account data, set advertising cookies, or run analytics by default.

The static site contains an optional GoatCounter integration. It is inactive unless the repository owner configures `PUBLIC_GOATCOUNTER_CODE` during deployment. When enabled, it records aggregate page views and these product events:

- Suite and single-skill install-command copies.
- GitHub and skills.sh outbound clicks.
- Inaccuracy-report clicks.
